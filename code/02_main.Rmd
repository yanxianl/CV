...
Contact {#contact}
--------------------------------------------------------------------------------
- <i class="fa fa-envelope"></i> yanxianl@nmbu.no
...
I'm a postdoc research fellow at [Norwegian University of Life Sciences](https://www.nmbu.no/en). My research interests include aquaculture, fish nutrition, gut health and microbiome. Currently, I’m working on *in-vitro* models for testing the nutritional and health effects of novel ingredients and feeds. 
...
Recent publications {data-icon=book}
--------------------------------------------------------------------------------
::: aside
