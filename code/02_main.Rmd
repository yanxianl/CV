...
position_data <- read_csv(here::here("data/positions.csv")) %>% 
  mutate_all(fill_nas) %>% 
...
I'm a Ph.D. research fellow at [Norwegian University of Life Sciences](https://www.nmbu.no/en). My research interests include aquaculture, fish nutrition, gut health and microbiome.
